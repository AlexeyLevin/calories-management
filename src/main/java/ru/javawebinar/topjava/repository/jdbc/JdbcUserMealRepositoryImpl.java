...
public class JdbcUserMealRepositoryImpl implements UserMealRepository {
    ...
    private final static RowMapper<UserMeal> ROW_MAPPER = (rs, rowNum) -> new UserMeal(rs.getInt("id"),
    ...
    public UserMeal get(int id, int userId) {
        List<UserMeal> userMeals = jdbcTemplate.query("SELECT * FROM meals WHERE user_id =? AND id =? ORDER BY datetime DESC", ROW_MAPPER, userId, id);
